...
import { SidebarContainer, SidebarMenu, SidebarMenuItem, Logo } from './Sidebar.style';
import { BiLayer, BiGridAlt, BiUser, BiMessage, BiFolder, BiBarChart, BiLogOut } from "react-icons/bi";
